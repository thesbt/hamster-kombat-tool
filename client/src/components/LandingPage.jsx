      ...
      <div className={styles.content}>
        ...
        <div className={styles["text-content"]}>
          ...
          <p className={styles.description}>
            Take your Hamster Kombat experience to the next level. Our tool
            helps you easily track your in-game cards and identify the best
            cards to upgrade for maximum impact. Stay ahead in the game with
            smarter choices and faster upgrades!
          </p>
        </div>
      </div>
    </div>
